"""Config for c910_bench — runs with ORIGINAL gem5 (before C910 alignment).
Uses BaseO3CPU with standard parameters (no C910 IQ params)."""
...
# Use RiscvO3CPU (original version, no C910 IQ params)
system.cpu = RiscvO3CPU()

# Standard O3 parameters (same as default, no C910-specific params)
