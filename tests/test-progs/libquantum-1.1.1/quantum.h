...
extern void quantum_cond_phase_shift(int control, int target, float gamma, quantum_reg *reg);
...
extern void quantum_exp_mod_n(int N, int x, int width_input, int width, quantum_reg *reg);
...
extern double quantum_prob(double _Complex a);
...
extern double _Complex quantum_dot_product(quantum_reg *reg1, quantum_reg *reg2);
...
extern quantum_reg quantum_matrix_qureg(quantum_reg A(unsigned long long, double), double t, quantum_reg *reg, int flags);
extern void quantum_scalar_qureg(double _Complex r, quantum_reg *reg);
...
extern void quantum_rk4(quantum_reg *reg, double t, double dt, quantum_reg H(unsigned long long, double), int flags);
extern double quantum_rk4a(quantum_reg *reg, double t, double *dt, double epsilon, quantum_reg H(unsigned long long, double), int flags);

extern void quantum_diag_time(double t, quantum_reg *reg0, quantum_reg *regt, quantum_reg *tmp1, quantum_reg *tmp2, quantum_matrix H, double **w);

extern double quantum_groundstate(quantum_reg *reg, double epsilon, quantum_reg H(unsigned long long, double), int solver, double stepsize);
