"""Generic O3CPU config — works with both before/after C910 alignment."""
...
# Use RiscvO3CPU (exists in both before and after states)
system.cpu = RiscvO3CPU()

# Standard O3 parameters (compatible with both versions)
