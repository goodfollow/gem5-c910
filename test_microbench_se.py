"""C910-like IEW micro-benchmark SE test config."""
...
# Use the micro-benchmark binary as the compatible workload
binary = "tests/c910_microbench/c910_microbench"
...
# ============================================================
# RiscvO3CPU with C910-like parameters
# ============================================================
system.cpu = RiscvO3CPU()

# Pipeline widths (C910-like)
...
system.cpu.LSQDepCheckShift = 4
system.cpu.LSQCheckLoads = True

# Multi-IQ (C910 8-type)
system.cpu.aiq0Entries = 11
system.cpu.aiq1Entries = 11
system.cpu.biqEntries = 12
system.cpu.lsiqEntries = 16
system.cpu.sdiqEntries = 8
system.cpu.viq0Entries = 10
system.cpu.viq1Entries = 10
system.cpu.vmbEntries = 8

# PRF sizes
system.cpu.numPhysIntRegs = 95
system.cpu.numPhysFloatRegs = 48
system.cpu.numPhysVecRegs = 48
system.cpu.numPhysVecPredRegs = 32
system.cpu.numPhysMatRegs = 2
system.cpu.numPhysCCRegs = 0

# Writeback widths
system.cpu.pregWBWidth = 3
system.cpu.vregWBWidth = 3
system.cpu.eregWBWidth = 2
system.cpu.wbWidth = 3
...
print("Beginning C910 micro-benchmark simulation...")
