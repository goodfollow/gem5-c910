# C910 libquantum (462.libquantum - SPEC CINT2006) SE config
# Runs Shor's factoring algorithm on the C910-like O3 CPU
#
# Usage:
...
# Pipeline widths (same as c910_full_test)
cpu.fetchWidth = 3
cpu.decodeWidth = 3
cpu.renameWidth = 4
cpu.dispatchWidth = 4
...
# ============================================================
# Workload — libquantum shor (factor N=15)
# ============================================================
binary = os.path.join(
    m5_root,
    "tests",
...
# Shor's algorithm: shor [number] — factor 15 = 3 * 5 (SPEC 462.libquantum uses test input 15)
process = Process()
...
print("Beginning libquantum (Shor's algorithm, N=15) simulation...")
